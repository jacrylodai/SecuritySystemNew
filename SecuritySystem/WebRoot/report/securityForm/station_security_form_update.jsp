...
<html>
	...
	var securityFormId = "${securityForm.securityFormId}";
	...
	function updateSecurityForm() {
		...
		if(!checkForm()){
			...
			with(document.securityFormForm){
				action="report/securityForm/stationSecurityFormFunc.do?command=updateStationSecurityForm";
				method="post";
				submit();
			}
		}
	...
	<body class="body1" onload="pageOnLoad()">
		<form name="securityFormForm" target="_self" id="securityFormForm">
			...
			<input type="hidden" name="listState" value="${param.listState }">
			<div align="center">
				...
				<div align="center">
					<input name="btnAdd" class="button1" type="button" id="btnAdd"
						value="保存" onClick="updateSecurityForm()">
