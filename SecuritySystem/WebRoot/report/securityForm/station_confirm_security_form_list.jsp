...
<html>
	...
	function updateStationSecurityForm() {
		...
		if(count<1){
			...
			if(count>1){
				...
				with(document.securityFormForm){
					action="report/securityForm/stationSecurityFormFunc.do?command=updateStationSecurityFormPrepare&listState=${SecurityForm_STATE_CONFIRM}"
						+"&securityFormId="+selectedId;
					method="post";
					submit();
				}
	...
	function deleteStationSecurityForm() {
		...
		if(count>0){
			with(document.securityFormForm){
				action="report/securityForm/stationSecurityFormFunc.do?command=deleteStationSecurityForm&listState=${SecurityForm_STATE_CONFIRM}";
				method="post";
				submit();
			}
		}
	...
	function verifyStationSecurityForm() {
		...
		if(count>0){
			with(document.securityFormForm){
				action="report/securityForm/stationSecurityFormFunc.do?command=verifyStationSecurityForm";
				method="post";
				submit();
			}
		}
	...
	function querySecurityForm(){
		...
		with(document.securityFormForm){
			action="report/securityForm/stationSecurityFormFunc.do?command=listStationConfirmSecurityForm";
			method="post";
			submit();
		}
	}
			...
			<table width="95%" height="30" border="0" align="center"
				...
				<tr>
					...
					<td nowrap class="rd19" align="right">
			            ...
			            <pg:param name="command" value="listStationConfirmSecurityForm"/>
