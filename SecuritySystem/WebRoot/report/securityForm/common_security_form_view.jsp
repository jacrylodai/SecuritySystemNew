...
<html>
	...
	<body class="body1">
		<form name="securityFormForm" target="_self" id="securityFormForm">
			<input type="hidden" name="securityFormId" value="${securityForm.securityFormId }">
			<div align="center">
					...
					<tr>
						...
						<td width="40px" align="left">
							<input id="startDateString" name="startDateString"
								 value="${securityForm.startDateString }"
					...
					<tr>
						...
						<td width="40px" align="left">
							<input id="endDateString" name="endDateString"
								 value="${securityForm.endDateString }"
								 type="text" readonly="true">
						</td>
					</tr>
				...
				<table width="80%" border="0" cellpadding="0" cellspacing="0">
					<tr>
						...
						<input name="securityMachineTroubleNum" type="text"
							 size="8" value="${commonForm.securityMachineTroubleNum }"></td>
                ...
                <h4>安检查获违禁品数量</h4>
                <h4>安检查获违禁品总数量：${commonForm.checkDangerousObjectTotalNum }</h4>
                <h4>安检违禁品总数量占旅客发送人数比例：${securityForm.checkDangerousObjectTotalNumOnPeriodNumOfPassengers }（万分比）</h4>                
					...
					<tr>
					  <td width="15%" height="30px" align="left">${var.index+1}-${dangerousObjectItem.itemName }</td>
						...
						<input name="dangerousObjectItemNum_${var.index }" type="text"
							 size="8" value="${commonForm.checkDangerousObjectNumList[var.index] }">件</td>
					</tr>  
                    </c:forEach>
				...
				<table width="80%" border="0" cellpadding="0" cellspacing="0">
					<tr>
						...
						<input name="zhanquCheckNum" type="text" size="8"
							value="${commonForm.zhanquCheckNum }"></td>
						<td width="20%" height="30px" align="right"></td>
						<td width="13%" align="left"></td>
						<td width="20%" height="30px" align="right"></td>
						<td width="13%" align="left"></td>
				...
				<table width="80%" border="0" cellpadding="0" cellspacing="0">
					<tr>
						...
						<input name="militiamanCheckNum" type="text" size="8"
							value="${commonForm.militiamanCheckNum }"></td>
						<td width="20%" height="30px" align="right"></td>
						<td width="13%" align="left"></td>
						<td width="20%" height="30px" align="right"></td>
						<td width="13%" align="left"></td>
				...
				<table width="80%" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
						...
						<input name="practicePeopleNum" type="text" size="8"
							value="${commonForm.practicePeopleNum }"></td>
						<td width="20%" height="30px" align="right"></td>
						<td width="13%" align="left"></td>
					</tr>
				</table>         
				...
				<table width="80%" border="0" cellpadding="0" cellspacing="0">
					<tr>
                    	<td align="center">
						<textarea name="otherWorkInfo" rows="8" cols="90"
							>${commonForm.otherWorkInfo }</textarea>
                        </td>
					</tr>
				</table>   
                ...
                <h4>预检查获违禁品数量</h4>   
                <h4>预检查获违禁品总数量：${keyunForm.squareDangerousObjectTotalNum }</h4>
                <h4>预检违禁品总数量占旅客发送人数比例：${securityForm.squareDangerousObjectTotalNumOnPeriodNumOfPassengers }（万分比）</h4>                    
					...
					<tr>
					  <td width="15%" height="30px" align="left">${var.index+1}-${dangerousObjectItem.itemName }</td>
						...
						<input name="squareDangerousObjectNum_${var.index }" type="text"
							value="${keyunForm.squareDangerousObjectNumList[var.index] }" size="8">件</td>
					</tr>  
                    </c:forEach>
					...
					<tr>
						<c:forEach varStatus="varInside" begin="${var.index}" 
							...
							<input name="securityMachineCheckNum_${varInside.index }"
								 type="text" size="8" value="${commonForm.securityMachineCheckNumList[varInside.index] }">
							</td>
						</c:forEach>
					</tr>
					</c:forEach>
                ...
                <h4>查缉一体人数</h4>
                <h4>查缉一体总人数：${keyunForm.specialCodePeopleTotalNum }</h4>
                <h4>查缉一体总人数占旅客发送人数比例：${securityForm.specialCodePeopleTotalNumOnPeriodNumOfPassengers }（万分比）</h4>                    
					...
					<tr>
						<c:forEach varStatus="varInside" begin="${var.index}" end="${(var.index+1)>(specialCodeItemCount-1) ? (specialCodeItemCount-1):(var.index+1)}" step="1">
							...
							<input name="specialCodePeopleNum_${varInside.index }"
								value="${keyunForm.specialCodePeopleNumList[varInside.index] }"  type="text" size="8">个
							</td>
						</c:forEach>
					</tr>
					</c:forEach>
				...
				<table width="80%" border="0" cellpadding="0" cellspacing="0">
					<tr>
						...
						<input name="yanzhengUsingFakePaperNum" type="text" size="8"
							value="${keyunForm.yanzhengUsingFakePaperNum }"></td>
						<td width="20%" height="30px" align="right"></td>
						<td width="13%" align="left"></td>
						<td width="20%" height="30px" align="right"></td>
						<td width="13%" align="left"></td>
				...
				<table width="80%" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
                    	<td align="center">
						<textarea name="specialTrainIdentityWrongInfo" rows="8" cols="90">${keyunForm.specialTrainIdentityWrongInfo }</textarea>
                        </td>
					</tr>
				</table>
