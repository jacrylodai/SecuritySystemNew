...
<html>
	...
	function querySecurityForm(){
		...
		with(document.securityFormForm){
			action="report/securityForm/departmentSecurityFormFunc.do?command=listDepartmentConfirmSecurityForm";
			method="post";
			submit();
		}
	}
			...
			<table width="95%" height="30" border="0" align="center"
				...
				<tr>
					...
					<td nowrap class="rd19" align="right">
			            ...
			            <pg:param name="command" value="listDepartmentConfirmSecurityForm"/>
