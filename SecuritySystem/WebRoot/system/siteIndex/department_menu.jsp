...
// ---------------------------------------------------------------------------
  ...
  //create first panel
  p = new createPanel('p1','反恐报表管理');
  //link to another page....
  p.addButton('images/netm.gif','未上报-车间反恐报表维护','parent.frames.main.location.href="<%=basePath %>report/securityForm/departmentSecurityFormFunc.do?command=listDepartmentNotConfirmSecurityForm"');
  p.addButton('images/netm.gif','已上报-车间反恐报表维护','parent.frames.main.location.href="<%=basePath %>report/securityForm/departmentSecurityFormFunc.do?command=listDepartmentConfirmSecurityForm"');
  p.addButton('images/netm.gif','已审核-车间反恐报表维护','parent.frames.main.location.href="<%=basePath %>report/securityForm/departmentSecurityFormFunc.do?command=listDepartmentVerifySecurityForm"');
  <%--
  p.addButton('images/netm.gif','未上报-重点关注人员信息维护','parent.frames.main.location.href="<%=basePath %>report/specialPeopleInfo/departmentSpecialPeopleInfoFunc.do?command=listDepartmentNotConfirmSpecialPeopleInfo"');
   --%>
  o.addPanel(p);
